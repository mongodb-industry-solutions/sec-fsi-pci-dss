...
export default function SimulatorLandingPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 pb-12">
      ...
      {/* Step 2, Scenario */}
      <section className={`bg-white rounded-xl border p-5 mb-6 shadow-sm transition-opacity ${method ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
        <h2 className="font-semibold text-[#001E2B] mb-1 flex items-center gap-2">
        ...
        <p className="text-xs text-gray-500 mb-3">Which customer story should the demo follow?</p>
      ...
      <div className="text-center">
        ...
        {!ready && (
          <p className="text-xs text-gray-400 mt-2">Select a method and a scenario to continue</p>
        )}
      </div>
    </div>
  );
