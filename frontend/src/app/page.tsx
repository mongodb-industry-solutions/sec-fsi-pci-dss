    ...
    <div className="min-h-screen bg-[#001E2B] text-white flex flex-col items-center justify-center p-6">
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link
            href="/admin"
            className="group block rounded-xl border border-orange-500/30 bg-[#001E2B] hover:bg-orange-500/10 p-6 text-left transition-all"
          >
            <div className="text-3xl mb-3">⚙️</div>
            <h2 className="text-xl font-bold mb-2 text-orange-400">Administration Mode</h2>
            <p className="text-gray-400 text-sm mb-4">
              Configure the demo environment. Run setup commands, seed the database, and
              stream server logs in real time. Requires admin credentials.
            </p>
            <span className="inline-block bg-orange-500 text-white px-4 py-1.5 rounded font-semibold text-sm group-hover:opacity-90">
              Admin Panel
            </span>
          </Link>
        </div>
