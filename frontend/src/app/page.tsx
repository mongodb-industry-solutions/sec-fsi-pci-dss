  ...
  return (
    <div className="min-h-screen bg-[#001E2B] text-white flex flex-col items-center justify-center p-6">
      <div className="max-w-3xl w-full text-center">
        <div className="text-6xl mb-4"><div className="text-4xl mb-2"> <img src="/app-icon.png" alt="Securit4 Pay Icon" className="w-24 h-24 mx-auto" /> </div></div>
        <h1 className="text-3xl font-bold mb-2">Securit4 <span className="text-[#00ED64]">Pay</span> <span className="text-gray-400 font-medium text-md">(PSP - PCI DSS)</span></h1>
        ...
        <p className="mt-3 text-gray-600 text-xs">
          v{process.env.NEXT_PUBLIC_APP_VERSION ?? '0.0.0'} · Security Foundation · MongoDB Atlas · QE equality search · KMS fallback
        </p>
        <Link
          href="/admin"
