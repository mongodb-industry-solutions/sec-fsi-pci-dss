      ...
      {!ready ? (
        ...
        <>
          ...
          <div className="bg-white rounded-xl border p-5 space-y-3">
            ...
            <p className="text-xs text-gray-400 pt-1">Full PAN and CVV are never stored. Any reveal is ephemeral (on demand, re-hideable), routed via the card provider and audited server-side (PCI DSS Req 3.2/3.3, Req 10).</p>
          </div>
