...
// Dedicated config UI for the internal Card Issuer simulator (overrides the generic module editor
// for this capability). The rules are stored in the capability moduleConfig and enforced by the
// backend /modules/card-issuer/score endpoint. PCI DSS Req 3.2: the valid CVV is a fixed demo value,
// never a real card secret, and no PAN/CVV is ever stored.
  ...
  return (
    <div className="w-full px-5 sm:px-8 lg:px-12 py-6 space-y-5">
      ...
      <SectionHeader
        ...
        description="Simulator for card validation: a fixed valid CVV, per-network number-format checks, and the set of supported card networks. Rules are data-driven and enforced on every validation request."
        debugInfo="capability=card-issuer · SD-88 Payment Card · PCI DSS Req 3.2 (no SAD stored)"
      />
