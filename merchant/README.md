...
with the **Sec4 Pay PSP** purely via **OAuth2 / OIDC SSO + REST API**. It has **no database** and
...
PSP_MERCHANT_AUTHORIZE_URL=http://localhost:8086/realms/LeafyIdp/protocol/openid-connect/auth
