...
const SCOPE_HELP: Record<string, string> = {
  openid: 'Confirms who you are (your Securit4 Pay identity).',
...
const AUTH_ERROR_INFO: Record<string, { title: string; hint: string }> = {
  ...
  token_exchange_failed: {
    ...
    hint: 'Securit4 Pay approved the request but the token exchange failed. This is usually temporary. Please try again in a moment.',
  },
  access_denied: {
    ...
    <div className="space-y-8">
      <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-leaf-ink via-[#04322c] to-[#062b2b] p-8 text-white shadow-card sm:p-10">
        ...
        <span className="relative inline-flex items-center gap-1.5 rounded-full bg-leaf/15 px-3 py-1 text-xs font-medium text-leaf ring-1 ring-leaf/30">
          <ShieldCheck className="h-3.5 w-3.5" aria-hidden /> Powered by Securit4 Pay
        </span>
        ...
        <p className="relative mt-3 max-w-xl text-white/80">
          Premium coffee, powered by Securit4 Pay. Sign in with your Securit4 Pay account to shop, pay beneficiaries, and
      ...
      {/* Marketing: what the Securit4 Pay PSP offers, with a CTA into the full demo simulator. */}
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-muted">
              Espresso Works is just one way in. Behind it, <b>Securit4 Pay</b> powers the end-to-end PCI DSS journey on a
