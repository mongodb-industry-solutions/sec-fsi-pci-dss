    ...
    <div className="space-y-10">
      <header>
        ...
        <p className="mt-1 max-w-2xl text-sm text-muted">
          ...
          runs through the Sec4 Pay PSP over OAuth2/OIDC and its API.
        </p>
      </header>
      ...
      <section>
        ...
        <div className="glass flex flex-col items-stretch gap-3 rounded-2xl p-5 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-1 flex-col items-center rounded-xl bg-gradient-to-br from-leaf-ink to-[#04322c] p-4 text-center text-white ring-1 ring-leaf/30">
            ...
            <p className="mt-2 text-sm font-medium">Sec4 Pay PSP</p>
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Card icon={<KeyRound className="h-5 w-5" aria-hidden />} title="OAuth2 / OIDC SSO with PKCE">
            You sign in on Sec4 Pay, not here. We use the authorization-code flow with{' '}
      ...
      <section>
        <h2 className="mb-3 text-sm font-semibold uppercase tracking-wide text-muted">Why Sec4 Pay &amp; MongoDB</h2>
        <div className="grid gap-4 sm:grid-cols-2">
          <Card icon={<ShieldCheck className="h-5 w-5" aria-hidden />} title="Secure, PCI-aligned PSP">
            Card data and balances stay inside Sec4 Pay. The merchant offloads compliance scope and never stores
            cardholder data.
          </Card>
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <a href={apiDocsUrl} target="_blank" rel="noopener noreferrer"
            ...
            <p className="mt-3 text-sm text-muted">Interactive OpenAPI docs for the Sec4 Pay PSP API this storefront integrates with.</p>
          </a>
        </div>
      </section>
