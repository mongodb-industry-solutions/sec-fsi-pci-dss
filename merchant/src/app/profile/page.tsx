  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <h1 className="flex items-center gap-2 text-2xl font-bold">
        ...
        <InfoHint label={`Your ${BRAND.full} identity and the access you granted to Espresso Works. Managed in your ${BRAND.full} account.`} />
      </h1>
      ...
      <section className="glass rounded-2xl p-5">
        ...
        <dl className="mt-4 space-y-2 border-t border-line pt-4 text-sm">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <dd className="text-ink">{BRAND.full} SSO (OAuth 2.0 / OIDC)</dd>
          </div>
        </dl>
      </section>
      ...
      <section className="glass rounded-2xl p-5">
        ...
        <p className="mt-1 text-sm text-muted">
          What you allowed Espresso Works to do with your {BRAND.full} account. We never see your card, password or full IBAN.
        </p>
      ...
      <section className="rounded-2xl border border-line p-5">
        <p className="flex items-start gap-2 text-sm text-muted">
          ...
          Permissions are managed in your {BRAND.full} account. Re-authorize to change what Espresso Works can access, or sign out.
        </p>
