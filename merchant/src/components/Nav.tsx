...
export default async function Nav() {
  ...
  const all: (NavLink & { show: boolean })[] = [
    { href: '/products', label: 'Shop', icon: 'products', tip: 'Browse the catalogue, one product per Leafy Pay payment method.', show: true },
    ...
    { href: '/request-to-pay', label: 'Request to Pay', icon: 'transfers', tip: 'Request money and approve requests (RTP). The payer approves in-app.', show: hasScope(session, 'read:rtp') },
    ...
    { href: '/help', label: 'Help', icon: 'help', tip: 'How this integration works and why Leafy Pay / MongoDB.', show: true },
  ];
