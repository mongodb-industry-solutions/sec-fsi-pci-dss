...
export default async function Nav() {
  ...
  const all: (NavLink & { show: boolean })[] = [
    { href: '/products', label: 'Shop', icon: 'products', tip: 'Browse the catalogue, one product per Securit4 Pay payment method.', show: true },
    ...
    { href: '/help', label: 'Help', icon: 'help', tip: 'How this integration works and why Securit4 Pay / MongoDB.', show: true },
  ];
