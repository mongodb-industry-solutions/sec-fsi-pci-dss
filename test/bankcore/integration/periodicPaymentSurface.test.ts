...
import { issueAccessToken } from '../../../bankcore/src/modules/tpp-trust/services/tppAccessToken.service';
import { PERIODIC_PAYMENT_COLLECTION } from '../../../bankcore/src/modules/pisp/models/periodicPayment.model';
import { ACCOUNT_ARRANGEMENT_COLLECTION } from '../../../bankcore/src/modules/aspsp/models/accountArrangement.model';
import { BANK_CONSENT_AGREEMENT_COLLECTION } from '../../../bankcore/src/modules/consent/models/bankConsent.model';
