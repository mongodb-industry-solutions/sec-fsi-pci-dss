...
import { authenticateTpp, hashClientSecret } from '../../../bankcore/src/modules/tpp-trust/services/tppRegistration.service';
import { issueAccessToken, verifyAccessToken } from '../../../bankcore/src/modules/tpp-trust/services/tppAccessToken.service';
import { requireTpp } from '../../../bankcore/src/vendors/middleware/tppAuth';
import { config } from '../../../bankcore/src/config';
import type { TppRegistrationControlRecord } from '../../../bankcore/src/modules/tpp-trust/models/tppRegistration.model';
