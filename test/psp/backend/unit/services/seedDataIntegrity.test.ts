...
describe('v33 seed-data integrity: a complete population (D-3)', () => {
  ...
  it.skipIf(!HAS_LOGINS)('the curated login picker stays short while every customer is reachable', () => {
    ...
    // named person. Seventeen (sixteen plus Antonio Membrides, who owns the LeafyPay and BankCore
    // application registrations and is featured for exactly that reason) is still a curated fraction
    // of the population, which is the property.
