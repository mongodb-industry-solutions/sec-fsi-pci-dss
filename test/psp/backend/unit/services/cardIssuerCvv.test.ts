...
import { normalizeExpiry, DEFAULT_SERVICE_CODE } from '../../../../../psp/backend/src/providers/card-issuer/services/cardVerificationKey.service';
// v37 P7: the derivation moved to the issuer. Its own tests cover it; the PSP keeps only the formatting.
import { derivePerCardCvv } from '../../../../../bank/backend/src/vendors/encryption/cardVerificationKey.service';
import { validateCard, resolveCardIssuerConfig, DEFAULT_CARD_ISSUER_CONFIG, type CardIssuerSimulatorConfig } from '../../../../../psp/backend/src/providers/card-issuer/services/cardIssuer.service';
