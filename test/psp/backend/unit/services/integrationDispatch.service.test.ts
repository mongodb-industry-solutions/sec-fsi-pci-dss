...
vi.mock('../../../../../psp/backend/src/modules/provider/services/fieldMapping.service', () => ({
  applyMappings: vi.fn((p: unknown) => p),
}));

vi.mock('../../../../../psp/backend/src/modules/provider/services/integrationRoutingGroup.service', () => ({
