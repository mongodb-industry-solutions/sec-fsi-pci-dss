...
vi.mock('../../../../../psp/backend/src/vendors/security/escalationTokens', () => ({
...
import { canRevealKycSensitive, KYC_ADMIN_REVEAL_ROLES } from '../../../../../psp/backend/src/vendors/middleware/rbac';
