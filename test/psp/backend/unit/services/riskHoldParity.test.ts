...
vi.mock('../../../../../psp/backend/src/modules/fraud/services/fraudDiagnosis.service', () => ({ createFraudCase: h.createFraudCase }));
...
vi.mock('../../../../../psp/backend/src/modules/gateway/services/rtpRequest.service', () => ({
...
import { PostAuthorizationProcess } from '../../../../../psp/backend/src/modules/transaction/services/postAuthorization.process';
import { RtpLifecycleProcess } from '../../../../../psp/backend/src/modules/gateway/services/rtpLifecycle.process';
