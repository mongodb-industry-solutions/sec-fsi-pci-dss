...
} from '../../../../backend/src/vendors/seed/dataIntegrity';
import { deriveMaskedPan } from '../../../../backend/src/modules/customer/models/paymentCard.model';

const DATA = join(process.cwd(), 'backend', 'data');
