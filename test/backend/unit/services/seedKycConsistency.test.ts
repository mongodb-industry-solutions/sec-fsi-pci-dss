...
import { enrichKyc } from '../../../../backend/src/vendors/seed/seedCustomers';
import { getKycSearchRegistry } from '../../../../backend/src/modules/customer/services/customerAgreement.service';

const FIXTURES = join(process.cwd(), 'backend', 'data', 'customerAgreements.json');
