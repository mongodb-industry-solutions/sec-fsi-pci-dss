...
} from '../../../../backend/src/modules/identity/models/authenticationDomain.model';
...
describe('the realm and the protocol are different things', () => {
  it('does not rename the local authentication TYPE', () => {
    ...
    const model = require('fs').readFileSync(
      require('path').resolve(__dirname, '../../../../backend/src/modules/identity/models/authenticationDomain.model.ts'),
      'utf8',
    );
