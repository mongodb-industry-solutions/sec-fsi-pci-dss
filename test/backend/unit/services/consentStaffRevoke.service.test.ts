...
vi.mock('../../../../backend/src/modules/gateway/services/merchantWebhook.service', () => ({
  WebhookService: class {
    dispatch = h.dispatch;
  },
}));

import { revokeConsentGrant, resolveSubForParty } from '../../../../backend/src/modules/identity/services/oauth.service';
import { PARTY_AUTH_CONSENT_COLLECTION } from '../../../../backend/src/modules/identity/models/partyAuthConsent.model';
import { PARTY_ISSUED_TOKEN_COLLECTION } from '../../../../backend/src/modules/identity/models/partyIssuedToken.model';
import { CUSTOMER_AUTHENTICATION_COLLECTION } from '../../../../backend/src/modules/identity/models/customerAuthentication.model';
