...
vi.mock('../../../../backend/src/modules/gateway/services/transferRiskGate', () => ({
  screenTransfer: h.screenTransfer, openTransferFraudCase: h.openTransferFraudCase,
}));
vi.mock('../../../../backend/src/modules/gateway/services/payoutAccount.service', () => ({
...
import { executeP2PTransfer } from '../../../../backend/src/modules/gateway/services/p2pTransfer.service';
