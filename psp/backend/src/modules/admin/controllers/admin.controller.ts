...
const ALLOWED_NPM_COMMANDS: Record<string, string[]> = {
  ...
  'setup:db:bankcore': ['run', 'setup:db', '--prefix', 'bank/backend'],
  'setup:seed:bankcore': ['run', 'setup:seed', '--prefix', 'bank/backend'],
  'setup:db:drop:bankcore': ['run', 'setup:db:drop', '--prefix', 'bank/backend'],
  'setup:check:bankcore': ['run', 'setup:check', '--prefix', 'bank/backend'],
};
