...
// Checkout and payment-link routes are public so the simulator can use them without a JWT session
const PUBLIC_PREFIXES: string[] = ['/doc', '/api/v1/admin', '/api/v1/checkout', '/api/v1/payment-links'];
