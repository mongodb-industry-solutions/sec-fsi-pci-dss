...
export async function integrationWebhookController(fastify: FastifyInstance) {
  ...
  fastify.post<{ Params: { id: string } }>('/fds/:id', webhookOpts, async (request, reply) => {
  ...
  fastify.post<{ Params: { id: string } }>('/aml/:id', webhookOpts, async (request, reply) => {
    const { id } = request.params;
    const signature = request.headers['x-webhook-signature'] as string | undefined;
    const bodyRaw = JSON.stringify(request.body);
  ...
  fastify.post<{ Params: { id: string } }>('/kyc/:id', webhookOpts, async (request, reply) => {
    const { id } = request.params;
    const signature = request.headers['x-webhook-signature'] as string | undefined;
    const bodyRaw = JSON.stringify(request.body);
  ...
  fastify.post<{ Params: { id: string } }>('/kyb/:id', webhookOpts, async (request, reply) => {
    const { id } = request.params;
    const signature = request.headers['x-webhook-signature'] as string | undefined;
    const bodyRaw = JSON.stringify(request.body);
  ...
  fastify.post<{ Params: { id: string } }>('/hrp/:id', webhookOpts, async (request, reply) => {
    const { id } = request.params;
    const signature = request.headers['x-webhook-signature'] as string | undefined;
    const bodyRaw = JSON.stringify(request.body);
  ...
  fastify.post<{ Params: { id: string } }>('/generic/:id', webhookOpts, async (request, reply) => {
    const { id } = request.params;
    const signature = request.headers['x-webhook-signature'] as string | undefined;
    const bodyRaw = JSON.stringify(request.body);
  ...
  fastify.post<{ Params: { id: string } }>('/card/authorization/:id', webhookOpts, async (request, reply) => {
    const { id } = request.params;
    const signature = request.headers['x-webhook-signature'] as string | undefined;
    const bodyRaw = JSON.stringify(request.body);
  ...
  fastify.post<{ Params: { id: string } }>('/card/issuer/:id', webhookOpts, async (request, reply) => {
    const { id } = request.params;
    const signature = request.headers['x-webhook-signature'] as string | undefined;
    const bodyRaw = JSON.stringify(request.body);
