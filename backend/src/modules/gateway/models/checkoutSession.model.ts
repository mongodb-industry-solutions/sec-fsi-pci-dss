// Payment Order - Checkout Session Control Record
...
export interface CheckoutSessionRecord {
  ...
  checkoutSessionActingSubjectReference?: string; // OAuth subject (customerAuthenticationInstanceReference)
  checkoutSessionActingPartyReference?: string;   // partyInstanceReference (resolved from the subject)
